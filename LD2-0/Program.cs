...
namespace LD2_0
{
    internal static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                cache = InitializeCache(i + 1, w + 1, -1);
        ...
        static int Gc(int k, int r)
        {
            ...
            {
                count++;
                if (rr == 0 || kk == 0) cache[kk, rr] = 0;

                else if (s[kk - 1] > rr) cache[kk, rr] = cache[kk - 1, rr];

                else cache[kk, rr] = Math.Max(cache[kk - 1, rr], p[kk - 1] + cache[kk - 1, rr - s[kk - 1]]);
            }
